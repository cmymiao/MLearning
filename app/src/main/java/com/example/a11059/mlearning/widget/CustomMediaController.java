package com.example.a11059.mlearning.widget;
...
public class CustomMediaController extends MediaController {
    ...
    protected View makeControllerView() {
        ...
        View v = ((LayoutInflater) getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.video_controller, this);
    ...
    private class MyGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            if (mOldX > windowWidth * 1.0 / 2.0) {
                //右边滑动 超过屏幕右侧3/4
                onVolumeSlide((mOldY - y) / windowHeight);
            } else if (mOldX < windowWidth * 1.0 / 2.0) {
                //左边滑动 不超过屏幕左侧1/4
    ...
    private void onVolumeSlide(float percent) {
        ...
        if (index >= 10) {
            mOperationBg.setImageResource(R.drawable.video_volmn_100);
        } else if (index >= 5 && index < 10) {
            mOperationBg.setImageResource(R.drawable.video_volmn_60);
        } else if (index > 0 && index < 5) {
            mOperationBg.setImageResource(R.drawable.video_volmn_30);
        } else {
            mOperationBg.setImageResource(R.drawable.video_volmn_no);
        }
    }
    ...
    private void onBrightnessSlide(float percent) {
        ...
        if (lpa.screenBrightness * 100 >= 90) {
            mOperationBg.setImageResource(R.drawable.video_brightness);
