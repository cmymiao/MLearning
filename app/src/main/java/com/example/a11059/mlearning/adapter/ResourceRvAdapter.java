...
/**
 * Created by 11059 on 2018/8/3.
 */

public class ResourceRvAdapter extends RecyclerView.Adapter<ResourceRvAdapter.ViewHolder> {

    private ResourceActivity parentActivity;
    ...
    public ResourceRvAdapter(ResourceActivity activity, List<Resource> resourceList){
    ...
    @NonNull
    @Override
    public ResourceRvAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(mContext == null){
            mContext = parent.getContext();
        }
        View view = LayoutInflater.from(mContext).inflate(R.layout.resource_recyclerview, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ResourceRvAdapter.ViewHolder holder, int position) {
