...
public class MistakeRvAdapter extends RecyclerView.Adapter<MistakeRvAdapter.ViewHolder>{
    ...
    private List<MistakeL> mistakeList;

    private SparseBooleanArray mSelectStates = new SparseBooleanArray();

    public MistakeRvAdapter(List<MistakeL> errorList, QuestionLocalActivity activity){
        parentActivity = activity;
        mistakeList = errorList;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MistakeRvAdapter.ViewHolder(view);
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        final MistakeL question = mistakeList.get(lPosition);
        ...
        holder.delButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                delQuestionFromErrorSet(lPosition);
            }
        });
    ...
    private void checkOption(String option, ViewHolder holder, boolean needSaveError){
        ...
        MistakeL question = mistakeList.get(position);
    ...
    private void delQuestionFromErrorSet(int pos){
        MistakeL error = mistakeList.get(pos);
        error.delete();
        mistakeList.remove(pos);
        notifyItemRemoved(pos);
        notifyItemRangeChanged(pos, mistakeList.size() - pos);
    ...
    private SpannableString getOptionIconString(MistakeL question, int option){
    ...
    public int getItemCount() {
        return mistakeList == null ? 0 : mistakeList.size();
    }
